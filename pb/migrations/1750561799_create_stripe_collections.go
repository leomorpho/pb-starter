...
func init() {
	m.Register(func(app core.App) error {
		...
		// Set access rules - only users can see their own customer record
		customers.ListRule = types.Pointer("user_id = @request.auth.id")
		customers.ViewRule = types.Pointer("user_id = @request.auth.id")
		...
		// Set access rules - only users can see their own subscriptions
		subscriptions.ListRule = types.Pointer("user_id = @request.auth.id")
		subscriptions.ViewRule = types.Pointer("user_id = @request.auth.id")
