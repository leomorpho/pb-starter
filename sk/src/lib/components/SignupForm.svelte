...
<div class={cn("flex flex-col gap-6", className)} bind:this={ref} {...restProps}>
    ...
    <div class="flex flex-col gap-6">
      ...
      <div class="flex flex-col gap-6">
        <div class="grid gap-3">
          ...
          <Input id="name-{formId}" type="text" placeholder="John Doe" required />
        </div>
        <div class="grid gap-3">
          <Label for="email-{formId}">Email</Label>
          <Input id="email-{formId}" type="email" placeholder="m@example.com" required />
        </div>
        <div class="grid gap-3">
          <Label for="password-{formId}">Password</Label>
          <Input id="password-{formId}" type="password" placeholder="Create a password" required />
        </div>
  ...
  >
    By creating an account, you agree to our <a href="/terms" class="hover:text-primary underline underline-offset-4">Terms of Service</a>
